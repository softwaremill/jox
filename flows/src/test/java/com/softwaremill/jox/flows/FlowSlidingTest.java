...
public class FlowSlidingTest {
    ...
    void shouldCreateSlidingWindowsForN2AndStep1() throws Exception {
        List<List<Integer>> result = Flows.fromValues(1, 2, 3, 4).sliding(2, 1).runToList();
    ...
    void shouldCreateSlidingWindowsForN3AndStep1() throws Exception {
        List<List<Integer>> result = Flows.fromValues(1, 2, 3, 4, 5).sliding(3, 1).runToList();
    ...
    void shouldCreateSlidingWindowsForN2AndStep2() throws Exception {
        List<List<Integer>> result = Flows.fromValues(1, 2, 3, 4, 5).sliding(2, 2).runToList();
    ...
    void shouldCreateSlidingWindowsForN3AndStep2() throws Exception {
        List<List<Integer>> result = Flows.fromValues(1, 2, 3, 4, 5, 6).sliding(3, 2).runToList();
    ...
    void shouldCreateSlidingWindowsForN1AndStep2() throws Exception {
        List<List<Integer>> result = Flows.fromValues(1, 2, 3, 4, 5).sliding(1, 2).runToList();
    ...
    void shouldCreateSlidingWindowsForN2AndStep3() throws Exception {
        List<List<Integer>> result = Flows.fromValues(1, 2, 3, 4, 5, 6).sliding(2, 3).runToList();
    ...
    void shouldCreateSlidingWindowsForN2AndStep3With1ElementRemainingInTheEnd() throws Exception {
        List<List<Integer>> result =
                Flows.fromValues(1, 2, 3, 4, 5, 6, 7).sliding(2, 3).runToList();
