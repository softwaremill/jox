...
public class ForkTest {
    ...
    void testRunTwoForksConcurrently() throws Exception {
        ...
        assertIterableEquals(Arrays.asList("main mid", "f1 complete", "f2 complete", "result = 11"), trail.get());
    }
    ...
    void testNestedForks() throws Exception {
        ...
        assertIterableEquals(Arrays.asList("f2 complete", "f1 complete", "result = 11"), trail.get());
    }
    ...
    void testInterruptChildForksWhenParentsComplete() throws Exception {
        ...
        assertIterableEquals(Arrays.asList("main mid", "f1 complete", "result = 5", "f2 interrupted"), trail.get());
    }
}
