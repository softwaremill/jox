...
public class ExceptionTest {
    ...
    void testUnsupervisedThrowsExceptionThrownByJoinedFork() throws InterruptedException {
        ...
        try {
            ...
            // the first EE, wraps CE, and is thrown by the join(); the second - wraps the first and
            // is thrown by unsupervised
    ...
    void testSupervisedInterruptsOtherForksWhenFailureAddSuppressedInterruptedExceptions()
        ...
        assertIterableEquals(
                List.of(
                        "CustomException",
                        "JoxScopeExecutionException(suppressed=InterruptedException,InterruptedException)"),
                trail.get());
    }
    ...
    void testSupervisedInterruptsOtherForksWhenFailureAddSuppressedCustomExceptions()
        ...
        assertIterableEquals(
                List.of(
                        "CustomException",
                        "JoxScopeExecutionException(suppressed=CustomException2)"),
                trail.get());
    }
    ...
    void testSupervisedDoesNotAddOriginalExceptionAsSuppressed() throws InterruptedException {
        ...
        // either join() might throw the original exception (shouldn't be suppressed), or it might
        ...
        List<String> expected2 =
                List.of("JoxScopeExecutionException(suppressed=InterruptedException)");
    ...
    void testSupervisedAddsExceptionAsSuppressedEvenIfWrapsOriginalException()
        ...
        assertIterableEquals(
                List.of(
                        "CustomException",
                        "JoxScopeExecutionException(suppressed=CustomException3)"),
                trail.get());
    }
    ...
    private void addExceptionWithSuppressedTo(Trail trail, Throwable e) {
        ...
        trail.add(
                e.getClass().getSimpleName() + "(suppressed=" + String.join(",", suppressed) + ")");
    }
}
